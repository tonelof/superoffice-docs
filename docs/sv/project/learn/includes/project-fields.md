...
1. **Type:** Choose the type of project here. Click the arrow to display a list of predefined types. This is a mandatory field and **must** therefore be filled in. [!include[SM](../../../learn/includes/are-defined-sm.md)]
...
1. **Status:** Specify the status of the project here. Click the arrow to display a list of predefined alternatives. [!include[SM](../../../learn/includes/are-defined-sm.md)]
...
1. **User-defined fields:** [!include[3 udef](../../../learn/includes/more-udef.md)]
