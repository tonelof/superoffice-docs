---
uid: help-sv-quote-add-alternative
...
3. Click the **+** (plus sign) tab in the **Edit quote** dialog.
    ...
    > [!NOTE]
    > If this tab is not displayed, alternatives are not enabled for the sales type of the current sale. You can select a different sales type, or enable alternatives for this sales type in Settings and maintenance.
